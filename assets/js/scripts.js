...
const writeTime = 100; // Tempo para escrever e apagar (em milissegundos)
const changeTextTime = 1000; // Tempo para mudar para a próxima frase (em milissegundos)
...
writeText(); // Iniciar a animação inicialmente